...
<div class="sidebar">
    ...
    <div class="nav-item">
        ...
        <div class="collapse" id="departmentDropdown">
            <a href="<?php echo e(route('departmentdash')); ?>" class="nav-link ps-4">VIEW DEPARTMENTS</a> <!-- Link to Department Dashboard -->
        </div>
        <div class="collapse" id="departmentDropdown">
            <a href="<?php echo e(route('buildingdash')); ?>" class="nav-link ps-4">BUILDINGS</a> <!-- Link to Department Dashboard -->
        </div>
    </div>
...
<?php /**PATH C:\Users\Justine Cedric\OneDrive\Desktop\BSIT 3-1 SMS FINAL\BSIT-3-1-SMS\resources\views/components/include/adminsidebar.blade.php ENDPATH**/ ?>